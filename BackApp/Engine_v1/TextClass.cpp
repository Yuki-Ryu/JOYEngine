							...
							D3DXMATRIX baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, "../Engine/data/Font/font01.txt", L"../Engine/data/Font/font01.dds");
	if (!result)
	{
...
bool TextClass::Render(ID3D11DeviceContext* deviceContext, ShaderManagerClass* FontShader, D3DXMATRIX worldMatrix, D3DXMATRIX orthoMatrix)
{
	bool result;
...
bool TextClass::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, ShaderManagerClass* FontShader, D3DXMATRIX worldMatrix,
...
bool TextClass::SetMousePosition(int mouseX, int mouseY, ID3D11DeviceContext* deviceContext)
{
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence11, mouseString, 10, 70, 1.0f, 1.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence12, mouseString, 10, 90, 1.0f, 1.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetRenderCount(int count, ID3D11DeviceContext* deviceContext)
{
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence13, countString, 10, 50, 1.0f, 1.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetFps(int fps, ID3D11DeviceContext* deviceContext)
{
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, fpsString, 10, 70, red, green, blue, deviceContext);
	if (!result)
	{
		return false;
	}
